...
def create_coding_team():
    ...
    assistant_4 = AssistantAgent(name="assistant_4", model_client=model_client, system_message="You are part of a team of AI agents. Your task is to look at the chosen version of the code and explain it's working.")
